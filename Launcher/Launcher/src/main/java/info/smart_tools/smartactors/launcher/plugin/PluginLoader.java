        ...
        for (IFeature feature : sortedFeatures) {
            ...
            try (JarFile jarFile = new JarFile(pathToJar)) {
                ...
                while (iterator.hasMoreElements()) {
                    ...
                    Class<?> pluginClass = classLoader.loadClass("info.smart_tools.smartactors.feature_loading_system.interfaces.iplugin.IPlugin");
...
//                    System.out.println("[DEBUG] Loading dependencies for feature \"" + feature.getName() + "\"");
                    for (IFeature dependency : dependencies) {
//                        System.out.println("[DEBUG] Adding dependency ID \"" + dependency.getId() + "\", name \"" + dependency.getName() + "\"");
                        ModuleManager.addModuleDependency(feature.getId(), dependency.getId());
                    }
                }

//                System.out.println("[DEBUG] Loaded feature \"" + feature.getName() + "\", initializing plugin load");
//                System.out.println("[DEBUG] Plugins loaded for feature \"" + feature.getName() + "\"");
            } catch (Throwable e) {
