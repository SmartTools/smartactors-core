...
import info.smart_tools.smartactors.remote_debug_viewer.common.JDIUtils;
...
public class VM {
    ...
    public VMBreakpoint createBreakpoint(final VMThread thread, final String frameName) {
        ...
        StackFrame breakpointFrame = JDIUtils.findFrameByName(thread.getThreadReference(), frameName);
