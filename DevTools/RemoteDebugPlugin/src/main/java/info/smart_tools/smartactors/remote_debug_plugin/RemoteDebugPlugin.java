...
public class RemoteDebugPlugin implements IPlugin {

    private final IBootstrap<IBootstrapItem<String>> bootstrap;

    public RemoteDebugPlugin(final IBootstrap<IBootstrapItem<String>> bootstrap) {
    ...
    public void load() throws PluginException {
        try {
            ...
            iocViewerItem
                    .process(() -> {
                        try {
                            Thread debugThread = new RemoteDebugThread();
                            debugThread.start();
                        } catch (Exception e) {
