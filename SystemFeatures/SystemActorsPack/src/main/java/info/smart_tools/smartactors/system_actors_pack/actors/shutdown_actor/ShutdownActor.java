...
public class ShutdownActor {
    ...
    private IUpCounter resolveUpCounter(final Object name) throws ResolutionException {
     ...
     */
    public void shutdown(final ShutdownRequestMessage message) throws
        ReadValueException,
        ResolutionException,
        UpCounterCallbackExecutionException,
        IllegalUpCounterState
    {
     ...
     * @throws IllegalUpCounterState if the system associated with upcounter is already down
     */
    public void forceShutdown(final ForceShutdownRequestMessage message) throws
        ReadValueException,
        ResolutionException,
        UpCounterCallbackExecutionException,
        IllegalUpCounterState
