 ...
 * "{@literal <}key{@literal >}": "keyValue" (value of {@literal <}key{@literal >} should be defined as a parameter of collection)
...
public interface ICachedCollection {
     ...
     * @throws ClearCachedMapException if any errors occurred
     */
