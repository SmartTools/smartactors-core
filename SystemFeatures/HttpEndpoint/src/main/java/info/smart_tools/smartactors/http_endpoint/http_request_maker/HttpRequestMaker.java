...
// Methods -----------------------------------------------------------------------------------------------------------
     ...
     *                            <a href="http://en.wikipedia.org/wiki/Real_Time_Streaming_Protocol">RTSP</a> and
     *                            <a href="http://en.wikipedia.org/wiki/Internet_Content_Adaptation_Protocol">ICAP</a></p>
     * <p>{@code headers} -       headers to be set, should presents as {@link List}&lt;{@link IObject}&gt;</p>
     * <p>{@code cookie} -        cookies to be set, should presents as {@link List}&lt;{@link IObject}&gt;</p>
