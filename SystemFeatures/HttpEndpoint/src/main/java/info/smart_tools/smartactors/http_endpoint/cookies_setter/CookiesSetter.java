...
// Methods -----------------------------------------------------------------------------------------------------------
    ...
    /**
     * Set cookie to a response using parameters from environment context(more priority) or endpoint config(cookies section, low priority).
     * <p>Cookies should presents as {@link List}&lt;{@link IObject}&gt;</p>
     * {@code
     *      "environment": {
     *          "context": {
     *              "cookies": [
