...
public class DeserializeStrategyPostJsonTest {
    ...
    @Test
    public void testDeserializationResult()
            throws InvalidArgumentException, ResolutionException, URISyntaxException, DeserializationException, SerializeException {
