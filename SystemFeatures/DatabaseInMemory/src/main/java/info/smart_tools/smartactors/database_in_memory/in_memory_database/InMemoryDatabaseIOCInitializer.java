...
public final class InMemoryDatabaseIOCInitializer {
    ...
    private static void initEqOperations(final Map<String, IConditionVerifier> verifierMap) {
        verifierMap.put("$eq", (condition, document) -> {
                    ...
                    try {
                        ...
                        Object reference = ((IObject) condition.getValue(fieldName))
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$eq")
                                );
        ...
        verifierMap.put("$neq", (condition, document) -> {
                    ...
                    try {
                        ...
                        Object reference = ((IObject) condition.getValue(fieldName))
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$neq")
                                );
                        return !reference.equals(entry);
                    } catch (ReadValueException | InvalidArgumentException | ResolutionException e) {
                    }
    ...
    private static void initGtLtOperations(final Map<String, IConditionVerifier> verifierMap) {
        verifierMap.put("$gt", (condition, document) -> {
                    ...
                    try {
                        ...
                        Object reference = ((IObject) condition.getValue(fieldName))
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$gt")
                                );
        ...
        verifierMap.put("$lt", (condition, document) -> {
                    ...
                    try {
                        ...
                        Object reference = ((IObject) condition.getValue(fieldName))
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$lt")
                                );
                        return (Integer) IOC.resolve(
                                Keys.getKeyByName("CompareSimpleObjects"), entry, reference
                        ) < 0;
        ...
        verifierMap.put("$gte", (condition, document) -> {
                    ...
                    try {
                        ...
                        Object reference = ((IObject) condition.getValue(fieldName))
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$gte")
                                );
                        return (Integer) IOC.resolve(
                                Keys.getKeyByName("CompareSimpleObjects"), entry, reference
                        ) >= 0;
        ...
        verifierMap.put("$lte", (condition, document) -> {
                    ...
                    try {
                        ...
                        Object reference = ((IObject) condition.getValue(fieldName))
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$lte")
                                );
                        return (Integer) IOC.resolve(
                                Keys.getKeyByName("CompareSimpleObjects"), entry, reference
                        ) <= 0;
                    ...
                    try {
                        ...
                        String reference = String.valueOf(
                                ((IObject) condition.getValue(fieldName))
                                        .getValue(
                                                IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$date-from")
                                        )
                        );
        ...
        verifierMap.put("$date-to", (condition, document) -> {
                    ...
                    try {
                        ...
                        String reference = String.valueOf(
                                ((IObject) condition.getValue(fieldName))
                                        .getValue(
                                                IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$date-to")
                                        )
                        );
                        return reference.compareTo(entry) == 1 || reference.equals(entry);
                    } catch (ReadValueException | InvalidArgumentException | ResolutionException e) {
        ...
        verifierMap.put("$in", (condition, document) -> {
                    ...
                    try {
                        ...
                        List<Object> references = (List<Object>)
                                ((IObject) condition.getValue(fieldName))
                                        .getValue(
                                                IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$in")
                                        );
        ...
        verifierMap.put("$isNull", (condition, document) -> {
                    ...
                    try {
                        ...
                        Boolean references = (Boolean)
                                ((IObject) condition.getValue(fieldName))
                                        .getValue(
                                                IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$isNull")
                                        );
    ...
    private static void initHasTagOperation(final Map<String, IConditionVerifier> verifierMap) {
        verifierMap.put("$hasTag", (condition, document) -> {
                    ...
                    try {
                        ...
                        Object reference = ((IObject) condition.getValue(fieldName))
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$hasTag")
                                );
        ...
        verifierMap.put("$fulltext", (condition, document) -> {
                    ...
                    try {
                        ...
                        String reference = String.valueOf(
                                ((IObject) condition.getValue(fieldName))
                                        .getValue(
                                                IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$fulltext")
                                        )
                        );
    ...
    private static void initConditions(final Map<String, IConditionVerifier> verifierMap) {
        verifierMap.put("$and", (condition, document) -> {
                    ...
                    try {
                        List<IObject> conditions = (List<IObject>) condition
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$and")
                                );
        ...
        verifierMap.put("$or", (condition, document) -> {
                    ...
                    try {
                        List<IObject> conditions = (List<IObject>) condition
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$or")
                                );
                        for (IObject conditionItem : conditions) {
                            result |= verifierMap.get("$general_resolver")
                                    .verify(conditionItem, document);
        ...
        verifierMap.put("$not", (condition, document) -> {
                    ...
                    try {
                        List<IObject> conditions = (List<IObject>) condition
                                .getValue(
                                        IOC.resolve(Keys.getKeyByName("info.smart_tools.smartactors.iobject.ifield_name.IFieldName"), "$not")
                                );
                        for (IObject conditionItem : conditions) {
    ...
    private static void registerDataBaseItem() throws RegistrationException, ResolutionException, InvalidArgumentException {
        IOC.register(Keys.getKeyByName(DataBaseItem.class.getCanonicalName()), new ApplyFunctionToArgumentsStrategy(
                        (args) -> {
                            try {
