 ...
 */
public class PluginInMemoryDBTasksTest extends IOCInitializer {
    ...
    protected void registerMocks() throws Exception {
        IOC.register(Keys.getKeyByName(IField.class.getCanonicalName()), new ApplyFunctionToArgumentsStrategy(
                        (args) -> {
                            try {
