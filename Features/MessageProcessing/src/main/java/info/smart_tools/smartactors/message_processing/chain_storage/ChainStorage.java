...
public class ChainStorage implements IChainStorage {
    ...
    public void register(final Object chainId, final IObject description)
        ...
        try {
            ...
            if (null != oldState) {
                System.out.println(MessageFormat.format("[\033[1;33mWARNING\033[0m] Replacing chain ({0}) registered as ''{1}'' by {2}",
    ...
    public void unregister(final Object chainId) {
        ...
        if (null == oldState) {
            System.out.println(MessageFormat.format("[\033[1;33mWARNING\033[0m] ''{1}'' has no chains, nothing to delete",
                    chainId.toString()));
        }
    }
